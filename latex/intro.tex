...
\begin{enumerate}
    ...
    \item ¿Es diferente la dinámica de la Fase 2 cuando transita a SWS o REM, a partir de los vectores de incrustación (Embeddings) extraídos de los hipnogramas?
