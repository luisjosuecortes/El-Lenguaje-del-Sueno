...
El código fuente, los notebooks de análisis y la cohorte unificada están disponibles públicamente en el repositorio del proyecto, \url{https://github.com/luisjosuecortes/El-Lenguaje-del-Sueno}, para garantizar la reproducibilidad de los resultados.
